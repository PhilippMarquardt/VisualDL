...
class ASPP(nn.Module):
    def __init__(self, in_channels, out_channels): 
        ...
        self.conv_out = Conv2d(out_channels * 5, out_channels, 1, dilation=1, bias=False)
...
class DoubleUnet(nn.Module):
    def __init__(self, encoder_name = "resnet34", classes = 1):
        ...
        ##################################################
        self.aspp1 = ASPP(self.encoder1.out_channels[-1], self.encoder1.out_channels[-1])
        self.aspp2 = ASPP(self.encoder1.out_channels[-1], self.encoder1.out_channels[-1])
