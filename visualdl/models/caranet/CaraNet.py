...
class caranet(nn.Module):
    def __init__(self, channel=32, num_classes=1):
        ...
        self.class1 = nn.Conv2d(1, num_classes, 1)
        self.class2 = nn.Conv2d(1, num_classes, 1)
        self.class3 = nn.Conv2d(1, num_classes, 1)
        self.class4 = nn.Conv2d(1, num_classes, 1)
    ...
    def forward(self, x):
        ...
        return self.class4(lateral_map_5)
        # return self.class4(lateral_map_5),self.class3(lateral_map_3),self.class2(lateral_map_2),self.class1(lateral_map_1)
